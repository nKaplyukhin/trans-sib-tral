...
const index_form = document.querySelector(".form");

const openForm = () => {
  index_form.classList.add("form_active");
  document.body.style.overflow = "hidden";
};

const closeForm = () => {
  index_form.classList.remove("form_active");
...
const addFormButtonsListener = () => {
  ...
  const closeFormButton = index_form.querySelector(".form__close-button");

  index_form.addEventListener("click", (e) => {
    const modalContent = index_form.querySelector(".form__container");
